...
FB.Event.subscribe('auth.logout', logout_event);
  ...
  FB.api('/me',{fields: 'last_name,first_name,gender,id'}, function(response1){
    ...
    $.post("/users", {first_name: response1.first_name,last_name: response1.last_name, facebook_id: response1.id, profile_pic_url: response2.data.url}, function(res) {console.log(res);});
    } });
