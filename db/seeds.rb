...
Vote.create(user: u3, votable: e3, vote_direction: 1)
...
Vote.create(user: u3, votable: e8, vote_direction: 1)
...
Vote.create(user: u3, votable: e13, vote_direction: 1)
...
Vote.create(user: u3, votable: e18, vote_direction: 1)
