...
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
...
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
User.create(first_name: "Mitch", popularity: 100, profile_pic_url: default_pic)
User.create(first_name: "Should be 100", popularity: 100, profile_pic_url: default_pic)
